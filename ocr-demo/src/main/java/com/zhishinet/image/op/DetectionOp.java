 ...
 */
package com.zhishinet.image.op;

import com.zhishinet.image.util.ClientConfig;
import com.zhishinet.image.common_utils.CommonCodecUtils;
import com.zhishinet.image.common_utils.CommonFileUtils;
import com.zhishinet.image.exception.AbstractImageException;
import com.zhishinet.image.exception.ParamException;
import com.zhishinet.image.http.AbstractImageHttpClient;
import com.zhishinet.image.http.HttpContentType;
import com.zhishinet.image.http.HttpMethod;
import com.zhishinet.image.http.HttpRequest;
import com.zhishinet.image.http.RequestBodyKey;
import com.zhishinet.image.http.RequestHeaderKey;
import com.zhishinet.image.request.AbstractBaseRequest.BytesContent;
...
import com.zhishinet.image.sign.Credentials;
import com.zhishinet.image.sign.Sign;
...
import static com.zhishinet.image.util.ClientConfig.*;
...
public class DetectionOp extends BaseOp {
     ...
     * @throws AbstractImageException SDK定义的Image异常, 通常是输入参数有误或者环境问题(如网络不通)
     */
    public String handwritingOcr(GeneralOcrRequest request) throws AbstractImageException {
        request.check_param();

        String sign = Sign.appSign(cred, request.getBucketName(), this.config.getSignExpired());
        String url = "http://" + this.config.getQCloudOcrDomain()+ OCR_HANDWRITING;
