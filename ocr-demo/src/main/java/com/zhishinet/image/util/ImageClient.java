...
import com.zhishinet.image.exception.UnknownException;
import com.zhishinet.image.http.AbstractImageHttpClient;
import com.zhishinet.image.http.DefaultImageHttpClient;
import com.zhishinet.image.op.DetectionOp;
import com.zhishinet.image.request.AbstractBaseRequest;
...
public class ImageClient implements Image {
    ...
    public String handwritingOcr(GeneralOcrRequest request) {
        try {
            return detectionOp.handwritingOcr(request);
        } catch (AbstractImageException e) {
            recordException("handwritingOcr", request, e.toString());
            return e.toString();
        } catch (Exception e) {
            UnknownException e1 = new UnknownException(e.toString());
            recordException("handwritingOcr", request, e1.toString());
            return e1.toString();
        }
    }
